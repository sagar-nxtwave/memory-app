...
export default function RegisterPage() {
  ...
  const inputClass = "font-sf w-full px-3.5 py-3 text-base text-gray-900 dark:text-white bg-white dark:bg-[#111111] border border-gray-200 dark:border-gray-700 rounded-xl outline-none focus:border-gray-400 dark:focus:border-gray-500 transition-colors placeholder:text-gray-400 dark:placeholder:text-gray-600"
  ...
  return (
    <div className="bg-white dark:bg-[#1a1a1a] rounded-3xl shadow-[0_4px_16px_rgba(0,0,0,0.08)] border border-gray-100 dark:border-gray-800 p-5 sm:p-8">
      <h2 className="font-sf text-lg font-semibold text-gray-900 dark:text-white mb-6">Create account</h2>

      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label className="font-sf block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Name</label>
