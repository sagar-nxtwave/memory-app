...
// Reprocesses every document in the space in a loop — even more exposed to timeouts than
// a single upload. See src/app/api/documents/route.ts for the full reasoning.
