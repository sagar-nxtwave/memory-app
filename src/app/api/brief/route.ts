    ...
    async start(controller) {
      ...
      try {
        ...
        if (readyDocs.length === 0) {
          fullContent = `Hi, I'm Memory — your AI assistant for this project. I can help you understand your documents, search CRM data, or answer any questions you have. What would you like to know?`
